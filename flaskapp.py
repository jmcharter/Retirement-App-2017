...
# in a non test environment this should be kept secret
...
def page_not_found(error):
        return 'Problem caused by {}'.format(request.url), 404
...
def test():
    ...
    title = "FlaskApp"
    paragraph = "Welcome to this Flask Application 2.0 (flaskapp)"
    activePage = "index"
